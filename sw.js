...
const CACHE_NAME = "2kor-shell-v8"; // v7 -> v8: เพิ่มป้ายบรรจุภัณฑ์แยกจากชื่อเมนู ผลไม้ชนิดเดียวกันตั้งชื่อซ้ำได้ถ้าป้ายบรรจุภัณฑ์ต่างกัน (ไม่ต้องพิมพ์ขนาดต่อท้ายชื่อเอง) + ปรับ stockOut ให้เร็วขึ้น
const SHELL_FILES = [
  "./",
  "./index.html",
  "./style.css",
